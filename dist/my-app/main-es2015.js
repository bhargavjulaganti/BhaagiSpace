...
let BenchpressComponent = class BenchpressComponent {
    constructor() {
...
let DeadliftComponent = DeadliftComponent_1 = class DeadliftComponent {
    constructor(http) {
        this.http = http;
        this.map = new Map([
    ...
    PostWorkout() {
        ...
        const url = `${DeadliftComponent_1.hostName}/PostDataIntoDynamo`;
...
let MyworkoutComponent = MyworkoutComponent_1 = class MyworkoutComponent {
    constructor(http) {
        this.http = http;
...
let SquatComponent = class SquatComponent {
    constructor() { }
    ngOnInit() {
    }
};
